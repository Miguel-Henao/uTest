...
public class uTestLoginPage {
    public static final Target LOGIN_BUTTON = Target.the("button that shows us the form to login").located(By.xpath("//ul[@class='nav navbar-nav']//a[contains(text(),'Log In')]"));
    ...
    public static final Target ENTER_BUTTON = Target.the("button to comfirm login").located(By.xpath("//button[contains(@class,'btn')]"));
}
